...
//             </div>
//           </div>
//           {/* filter books by authers */}
//           <div className='bg-white border rounded-xl mt-5'>
//             <h1 className='font-semibold border-b py-4 px-14 text-xl'>authers</h1>
//             <div className='px-14'>
//               {bookData.map((book, index) => (
//                 <ul key={index} className='py-2 text-gray-600 flex space-x-2 items-center hover:text-red-600 cursor-pointer'>
//                   <input
//                     type="checkbox"
//                     checked={auther === book.auther}
//                     onChange={(e) => handleSelectChange(setauther, e.target.checked ? book.auther : '')}
//                   /><li>{book.auther}</li>
//                 </ul>
//               ))}
//             </div>
...
//             <div className='border px-4 py-1 rounded cursor-pointer'>
//               Show
//               <select name="" id="" value={genre} onChange={(e) => handleSelectChange(setGenre, e.target.value)}>
